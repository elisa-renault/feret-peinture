 ...
 * post types registered by the métier plugin. No schema is editable by Christophe Feret.
...
return [
    ...
    'fp_information' => [
        ...
        'fields' => [
            'phone_mobile' => [ 'label' => 'Téléphone mobile public', 'type' => 'text', 'description' => 'Affiché sur le site pour prendre rendez-vous avec Christophe Feret avant l’établissement du devis.' ],
