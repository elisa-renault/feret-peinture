...
<nav class="primary-nav" id="navigation-principale" aria-label="Navigation principale"><?php fp_theme_navigation(); ?><?php fp_theme_quote_button('Demander un rendez-vous', 'button--small button--primary nav-quote'); ?></nav>
</div></header>
