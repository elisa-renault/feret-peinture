...
<?php if (fp_theme_preview()) : ?><div class="preview-strip" role="note">Prévisualisation · Coordonnées et prestations à confirmer avant publication.</div><?php endif; ?>
...
<nav class="primary-nav" id="navigation-principale" aria-label="Navigation principale"><?php fp_theme_navigation(); ?><?php fp_theme_quote_button('Demander un devis', 'button--small button--primary nav-quote'); ?></nav>
</div></header>
